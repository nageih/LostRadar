...
public record MapPalette(List<PaletteEntry> palette) {
    ...
    public record PaletteEntry(String name, int color, String translatableKey, int iconU, int iconV, Set<ResourceLocation> buildings) {
    }

    public static final PaletteEntry CITY = new PaletteEntry("city", 0xAAAAAA, "lostradar.city", -1, -1, Set.of());
    public static final PaletteEntry HIGHWAY = new PaletteEntry("highway", 0x000000, "lostradar.highway", -1, -1, Set.of());
    ...
    private static final Codec<PaletteEntry> PALETTE_ENTRY_CODEC = RecordCodecBuilder.create(instance -> instance.group(
        ...
        return new PaletteEntry(name, color, translatableKey, u, v, buildings);
    }));
